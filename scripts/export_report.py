...
def build_report_xlsx(conn, date_from=None, date_to=None) -> bytes:
    ...
    summary.append(["إجمالي الإيرادات", round(actual_revenue_total, 2)])
    summary.append(["التكلفة الأساسية", round(actual_base_total, 2)])
    summary.append(["رسوم وزن/COD محمَّلة", round(absorbed_fees_total, 2)])
    summary.append(["صافي الربح الفعلي", round(actual_profit_total, 2)])
